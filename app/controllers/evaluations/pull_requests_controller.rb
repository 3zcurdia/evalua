...
module Evaluations
  class PullRequestsController < ApplicationController
    ...
    def new
      @pull_request_evaluation = Evaluations::PullRequest.new
    end
    ...
    def create
      @pull_request_evaluation = Evaluations::PullRequest.new(pull_request_evaluation_params)
    ...
    def set_pull_request_evaluation
      @pull_request_evaluation = Evaluations::PullRequest.find(params[:id])
    end
