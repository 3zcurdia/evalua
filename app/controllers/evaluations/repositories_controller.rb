...
module Evaluations
  class RepositoriesController < ApplicationController
    ...
    def new
      @repository_evaluation = Evaluations::Repository.new
    end
    ...
    def create
      @repository_evaluation = Evaluations::Repository.new(repository_evaluation_params)
    ...
    def set_repository_evaluation
      @repository_evaluation = Evaluations::Repository.find(params[:id])
    end
