...
class UserEvaluationsControllerTest < ActionDispatch::IntegrationTest
  ...
  #     post user_evaluations_url, params: { user_evaluation: { source_url: @user_evaluation.source_url } }
  #   end
  #
  ...
  #   patch user_evaluation_url(@user_evaluation), params: { user_evaluation: { source_url: @user_evaluation.source_url } }
